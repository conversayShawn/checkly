...
[ Y ] Prometheus: Verify that the deployed checks are successfully generating metrics.

#### Final Delivery
[ Y ] Version Control: Push all code to this repo.

[ Y ] Submission: Email the repository link.